...
STATIC_FILES = {
    ...
    "data_check_reference":get_filename("tests/data/data_check_reference.nc"),
    "data_check_reference_outliers":get_filename("tests/data/data_check_reference_outliers.nc"),
    "data_check_reference_constant":get_filename("tests/data/data_check_reference_constant.nc"),
    "data_check_reference_FillValue":get_filename("tests/data/data_check_reference_FillValue.nc"),
    "data_check_reference_inf_neg":get_filename("tests/data/data_check_reference_inf_neg.nc"),
